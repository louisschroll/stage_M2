...
load("~/stage_M2/3.results/prediction_grid/grid_int_sterne_caugek_R.rdata")
load("~/stage_M2/3.results/mcmc_outputs/int_output_sterne_caugek_R.rdata")
...
# Load predictions
load(file = paste0(local_path, "3.results/prediction_grid/grid_", species, ".rdata"))
load("~/stage_M2/3.results/mcmc_outputs/int_output_sterne_caugek_HR.rdata")
load("~/stage_M2/3.results/prediction_grid/grid_int_sterne_caugek_HR.rdata")
...
load("~/stage_M2/3.results/prediction_grid/grid_goeland_leucophee_R2.rdata")
load("~/stage_M2/3.results/mcmc_outputs/int_output_goeland_leucophee_R.rdata")

make_fig_comparison(species,
                    fig_title = "Yellow-legged gull space-use (Summer)",
                    best_cov = best_cov)
```
...
load("~/stage_M2/3.results/prediction_grid/grid_goeland_leucophee_HR2.rdata")
load("~/stage_M2/3.results/mcmc_outputs/int_output_goeland_leucophee_HR.rdata")
...
map_leucophee_winter <- plot_maps_by_models_2col(species = species, 
                                         grid_occ = grid_occ, 
                                         grid_nmix = grid_nmix, 
                                         grid_RSF = grid_RSF, 
                                         grid_int = grid_int,
                                         title = "Yellow-legged gull (winter)") 

map_leucophee_winter
```
...
load("~/stage_M2/3.results/mcmc_outputs/int_output_petit_puffin_R.rdata")
load("~/stage_M2/3.results/prediction_grid/grid_int_petit_puffin_R.rdata")
...
map_yelkouan_summer <- plot_maps_by_models_2col(species = species, 
                                         grid_occ = grid_occ, 
                                         grid_nmix = grid_nmix, 
                                         grid_RSF = grid_RSF, 
                                         grid_int = grid_int,
                                         title = "Small shearwaters (Summer)") 
...
load("~/stage_M2/3.results/mcmc_outputs/int_output_petit_puffin_HR.rdata")
load("~/stage_M2/3.results/prediction_grid/grid_int_petit_puffin_HR.rdata")
...
map_yelkouan_winter <- plot_maps_by_models_2col(species = species, 
                                         grid_occ = grid_occ, 
                                         grid_nmix = grid_nmix, 
                                         grid_RSF = grid_RSF, 
                                         grid_int = grid_int,
                                         title = "Small shearwaters (Winter)") 
