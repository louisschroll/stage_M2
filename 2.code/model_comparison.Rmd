...
load(paste0(local_path, "3.results/prediction_grid/RSF_grid_puffin_de_scopoli_R.rdata"))
...
load(paste0(local_path, "3.results/prediction_grid/RSF_grid_sterne_caugek_R.rdata"))
save(grid_nmix, grid_RSF, grid_int,
       file = paste0(local_path, "3.results/prediction_grid/grid_", species, ".rdata"))
```
