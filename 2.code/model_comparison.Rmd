...
```{r load scopoli data}
load(paste0(local_path, "3.results/mcmc_outputs/mcmc_output_puffin_de_scopoli_R.rdata"))
load(paste0(local_path, "3.results/spOccupancy_outputs/spOccupancy_puffin_de_scopoli_R.RData"))
