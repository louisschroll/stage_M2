...
# Make predictions
grid_RSF <- make_prediction(mcmc.output = samplesRSF, grid, selected_cov, include_intercept = F, rsf_intercept = "beta_pop[1]")
...
ggplot() + 
  geom_point(data = df_RSF %>% filter(case==1), aes(x=X, y=Y, color = as.factor(individual_id)), alpha = 0.1) +
